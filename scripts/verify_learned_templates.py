...
def verify_learned_templates():
    ...
    # We specifically look for "learned" and "v2" tags
    learned = library.find_templates(tags=["v2"])
    print(f"Found {len(learned)} learned V2 templates.")

    if not learned:
        print("No learned V2 templates found! Check loading logic.")
        return

    output_dir = "data/verification/learned_v2"
